...
export const svg = genericElement<SVGSVGElement>('svg');
export const math = genericElement<MathMLElement>('math');
...
export const customElement = <T extends HTMLElement = HTMLElement>(tagName: string) =>
